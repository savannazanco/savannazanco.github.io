(function (window) {
    ...
    function init(game) {
        ...
        createCannon("left", 300); // a cannon on the left side of the screen, located at y = 300, with a 1 second delay (1000ms)
        createCannon("right", 344); // a canon on the right side of the screen, located at x = 344
